...
export default function ContactUs() {
  return (
    <div className="bg-cover object-cover bg-no-repeat flex justify-center items-center bg-center relative  h-[404px] bg-[url('https://i.ibb.co/XDY7Wb3/page-header.jpg')]">
